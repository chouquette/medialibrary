...
Subscription::trigger( Subscription::Triggers::IncrementUnplayedMedia, 37 ),
Subscription::trigger( Subscription::Triggers::DecrementUnplayedMedia, 37 ),
Subscription::trigger( Subscription::Triggers::DecrementUnplayedMediaOnDestroy, 37 ),
...
Service::trigger( Service::Triggers::UpdateUnplayedMedia, 37 ),
Service::trigger( Service::Triggers::DecrementUnplayedMediaOnSubRemoval, 37 ),
