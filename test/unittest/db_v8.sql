...
INSERT INTO `Settings` (db_model_version) VALUES (8);
...
INSERT INTO `Media` (id_media,type,subtype,duration,play_count,last_played_date,insertion_date,release_date,thumbnail,title,filename,is_favorite,is_present) VALUES (2,3,3,-1,NULL,NULL,1516637205,0,'','track_deleted.mp3','track_deleted.mp3',0,1);
INSERT INTO `File` (id_file,media_id,playlist_id,mrl,type,last_modification_date,size,folder_id,is_present,is_removable,is_external) VALUES (1,1,NULL,'track1.mp3',1,NULL,NULL,NULL,1,0,1);
COMMIT;
