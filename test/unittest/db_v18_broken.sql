...
CREATE TABLE IF NOT EXISTS Thumbnail(id_thumbnail INTEGER PRIMARY KEY AUTOINCREMENT,mrl TEXT,is_generated BOOLEAN NOT NULL,shared_counter INTEGER NOT NULL DEFAULT 0);
CREATE TABLE IF NOT EXISTS Task(id_task INTEGER PRIMARY KEY AUTOINCREMENT,step INTEGER NOT NULL DEFAULT 0,retry_count INTEGER NOT NULL DEFAULT 0,mrl TEXT,file_type INTEGER NOT NULL,file_id UNSIGNED INTEGER,parent_folder_id UNSIGNED INTEGER,parent_playlist_id INTEGER,parent_playlist_index UNSIGNED INTEGER,is_refresh BOOLEAN NOT NULL DEFAULT 0,UNIQUE(mrl,parent_playlist_id,is_refresh) ON CONFLICT FAIL,FOREIGN KEY(parent_folder_id) REFERENCES Folder(id_folder) ON DELETE CASCADE,FOREIGN KEY(parent_playlist_id) REFERENCES Playlist(id_playlist) ON DELETE CASCADE,FOREIGN KEY(file_id) REFERENCES File(id_file) ON DELETE CASCADE);
...
INSERT INTO Settings(db_model_version) VALUES(18);
CREATE TABLE IF NOT EXISTS PlaylistMediaRelation(media_id INTEGER,mrl STRING,playlist_id INTEGER,position INTEGER,FOREIGN KEY(media_id) REFERENCES Media(id_media) ON DELETE SET NULL,FOREIGN KEY(playlist_id) REFERENCES Playlist(id_playlist) ON DELETE CASCADE);
...
CREATE TABLE IF NOT EXISTS File(id_file INTEGER PRIMARY KEY AUTOINCREMENT,media_id UNSIGNED INT DEFAULT NULL,playlist_id UNSIGNED INT DEFAULT NULL,mrl TEXT,type UNSIGNED INTEGER,last_modification_date UNSIGNED INT,size UNSIGNED INT,folder_id UNSIGNED INTEGER,is_removable BOOLEAN NOT NULL,is_external BOOLEAN NOT NULL,is_network BOOLEAN NOT NULL,FOREIGN KEY(media_id) REFERENCES Media(id_media) ON DELETE CASCADE,FOREIGN KEY(playlist_id) REFERENCES Playlist(id_playlist) ON DELETE CASCADE,FOREIGN KEY(folder_id) REFERENCES Folder(id_folder) ON DELETE CASCADE,UNIQUE(mrl,folder_id) ON CONFLICT FAIL);cation_date UNSIGNED INT,size UNSIGNED INT,folder_id UNSIGNED INTEGER,is_removable BOOLEAN NOT NULL,is_external BOOLEAN NOT NULL,is_network BOOLEAN NOT NULL,UNIQUE(mrl,folder_id),FOREIGN KEY(media_id) REFERENCES Media(id_media) ON DELETE CASCADE,FOREIGN KEY(folder_id) REFERENCES Folder(id_folder) ON DELETE CASCADE,FOREIGN KEY(playlist_id) REFERENCES Playlist(id_playlist) ON DELETE CASCADE);
...
CREATE TABLE IF NOT EXISTS Bookmark(id_bookmark INTEGER PRIMARY KEY AUTOINCREMENT,time UNSIGNED INTEGER NOT NULL,name TEXT,description TEXT,media_id UNSIGNED INTEGER NOT NULL,FOREIGN KEY(media_id) REFERENCES Media(id_media),UNIQUE(time,media_id) ON CONFLICT FAIL);
...
CREATE TABLE IF NOT EXISTS Artist(id_artist INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT COLLATE NOCASE UNIQUE ON CONFLICT FAIL,shortbio TEXT,nb_albums UNSIGNED INT DEFAULT 0,nb_tracks UNSIGNED INT DEFAULT 0,mb_id TEXT,is_present UNSIGNED INTEGER NOT NULL DEFAULT 0 CHECK(is_present <= nb_tracks));
CREATE TABLE IF NOT EXISTS AlbumTrack(id_track INTEGER PRIMARY KEY AUTOINCREMENT,media_id INTEGER UNIQUE,duration INTEGER NOT NULL,artist_id UNSIGNED INTEGER,genre_id INTEGER,track_number UNSIGNED INTEGER,album_id UNSIGNED INTEGER NOT NULL,disc_number UNSIGNED INTEGER,FOREIGN KEY(album_id) REFERENCES Album(id_album) ON DELETE CASCADE,FOREIGN KEY(media_id) REFERENCES Media(id_media) ON DELETE CASCADE,FOREIGN KEY(artist_id) REFERENCES Artist(id_artist) ON DELETE CASCADE,FOREIGN KEY(genre_id) REFERENCES Genre(id_genre));
...
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(1,'file:///storage/emulated/0/Android/data/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(2,'file:///storage/emulated/0/Android/media/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(3,'file:///storage/emulated/0/Alarms/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(4,'file:///storage/emulated/0/Ringtones/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(5,'file:///storage/emulated/0/Notifications/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(6,'file:///storage/emulated/0/alarms/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(7,'file:///storage/emulated/0/ringtones/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(8,'file:///storage/emulated/0/notifications/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(9,'file:///storage/emulated/0/WhatsApp/Media/WhatsApp%20Animated%20Gifs/',NULL,NULL,1,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(10,'file:///storage/emulated/0/','0',NULL,0,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(11,'file:///storage/emulated/0/Android/','Android',10,0,1,0,0,0);
INSERT INTO Folder(id_folder,path,name,parent_id,is_banned,device_id,is_removable,nb_audio,nb_video) VALUES(12,'file:///storage/emulated/0/Music/','Music',10,0,1,0,0,0);
COMMIT;
