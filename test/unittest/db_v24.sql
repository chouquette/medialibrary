...
CREATE TABLE Device(id_device INTEGER PRIMARY KEY AUTOINCREMENT,uuid TEXT COLLATE NOCASE,scheme TEXT,is_removable BOOLEAN,is_present BOOLEAN,last_seen UNSIGNED INTEGER,UNIQUE(uuid,scheme) ON CONFLICT FAIL);
...
CREATE TABLE MediaGroup(id_group INTEGER PRIMARY KEY AUTOINCREMENT,parent_id INTEGER,name TEXT COLLATE NOCASE,nb_video UNSIGNED INTEGER DEFAULT 0,nb_audio UNSIGNED INTEGER DEFAULT 0,nb_unknown UNSIGNED INTEGER DEFAULT 0,FOREIGN KEY(parent_id) REFERENCES MediaGroup(id_group) ON DELETE CASCADE,UNIQUE(parent_id, name) ON CONFLICT FAIL);
...
CREATE TRIGGER media_group_increment_nb_media AFTER UPDATE OF type, group_id ON Media WHEN new.group_id IS NOT NULL AND (old.type != new.type OR IFNULL(old.group_id, 0) != new.group_id) BEGIN UPDATE MediaGroup SET nb_video = nb_video + (CASE new.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio + (CASE new.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown + (CASE new.type WHEN 0 THEN 1 ELSE 0 END) WHERE id_group = new.group_id; END;
CREATE TRIGGER media_group_decrement_nb_media AFTER UPDATE OF type, group_id ON Media WHEN old.group_id IS NOT NULL AND(old.type != new.type OR old.group_id != IFNULL(new.group_id, 0)) BEGIN UPDATE MediaGroup SET nb_video = nb_video - (CASE old.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio - (CASE old.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown - (CASE old.type WHEN 0 THEN 1 ELSE 0 END) WHERE id_group = old.group_id; END;
CREATE TRIGGER media_group_decrement_nb_media_on_deletion AFTER DELETE ON Media WHEN old.group_id IS NOT NULL BEGIN UPDATE MediaGroup SET nb_video = nb_video - (CASE old.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio - (CASE old.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown - (CASE old.type WHEN 0 THEN 1 ELSE 0 END) WHERE id_group = old.group_id; END;
CREATE INDEX media_group_parent_id_idx ON MediaGroup(parent_id);
...
INSERT INTO Media VALUES(1,2,3,10057,NULL,NULL,NULL,1579855228,2010,'Track 2','track_2.mp3',0,1,1,0,1,0,NULL,0,0);
INSERT INTO Media VALUES(2,2,3,10057,NULL,NULL,NULL,1579855228,2012,'Track 3','track_3.mp3',0,1,1,0,1,0,NULL,0,0);
INSERT INTO Media VALUES(3,2,3,10057,NULL,NULL,NULL,1579855228,2015,'Track 1','track_1.mp3',0,1,1,0,1,0,NULL,0,0);
INSERT INTO File VALUES(1,1,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_2.mp3',1,1531495970,139264,1,0,0,0);
INSERT INTO File VALUES(2,2,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_3.mp3',1,1531495970,139264,1,0,0,0);
INSERT INTO File VALUES(3,3,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_1.mp3',1,1531495970,139264,1,0,0,0);
INSERT INTO Album VALUES(1,'Compilation',3,0,NULL,3,30171,1,3);
INSERT INTO AlbumTrack VALUES(4,1,10057,7,NULL,0,1,0);
INSERT INTO AlbumTrack VALUES(5,2,10057,8,NULL,0,1,0);
INSERT INTO AlbumTrack VALUES(6,3,10057,9,NULL,0,1,0);
...
INSERT INTO Artist VALUES(3,'CommonArtist',NULL,1,3,NULL,3);
INSERT INTO Artist VALUES(7,'Artist 2',NULL,0,1,NULL,1);
INSERT INTO Artist VALUES(8,'Artist 3',NULL,0,1,NULL,1);
INSERT INTO Artist VALUES(9,'Artist 1',NULL,0,1,NULL,1);
INSERT INTO MediaArtistRelation VALUES(1,3);
INSERT INTO MediaArtistRelation VALUES(1,7);
INSERT INTO MediaArtistRelation VALUES(2,3);
INSERT INTO MediaArtistRelation VALUES(2,8);
INSERT INTO MediaArtistRelation VALUES(3,3);
INSERT INTO MediaArtistRelation VALUES(3,9);
INSERT INTO Task VALUES(1,3,0,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_2.mp3',1,1,1,0,0,0);
INSERT INTO Task VALUES(2,3,0,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_3.mp3',1,2,1,0,0,0);
INSERT INTO Task VALUES(3,3,0,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/compilation_different_years/track_1.mp3',1,3,1,0,0,0);
COMMIT;
