...
CREATE TABLE PlaylistMediaRelation(media_id INTEGER,mrl STRING,playlist_id INTEGER,position INTEGER,FOREIGN KEY(media_id) REFERENCES Media(id_media) ON DELETE NO ACTION,FOREIGN KEY(playlist_id) REFERENCES Playlist(id_playlist) ON DELETE CASCADE);
...
CREATE TABLE MediaGroup(id_group INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT COLLATE NOCASE,nb_video UNSIGNED INTEGER DEFAULT 0,nb_audio UNSIGNED INTEGER DEFAULT 0,nb_unknown UNSIGNED INTEGER DEFAULT 0,nb_present_video UNSIGNED INTEGER DEFAULT 0 CHECK(nb_present_video <= nb_video),nb_present_audio UNSIGNED INTEGER DEFAULT 0 CHECK(nb_present_audio <= nb_audio),nb_present_unknown UNSIGNED INTEGER DEFAULT 0 CHECK(nb_present_unknown <= nb_unknown),duration INTEGER DEFAULT 0,creation_date INTEGER NOT NULL,last_modification_date INTEGER NOT NULL,user_interacted BOOLEAN,forced_singleton BOOLEAN);
...
INSERT INTO Settings VALUES(30,2,6);
...
INSERT INTO Media VALUES(1,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep1-album1-track1','track1.mp3',0,1,1,0,4,0,NULL,0);
INSERT INTO Media VALUES(2,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep1-album1-track2','track2.mp3',0,1,1,0,4,0,NULL,0);
INSERT INTO Media VALUES(3,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep1-album1-track3','track3.mp3',0,1,1,0,4,0,NULL,0);
INSERT INTO Media VALUES(4,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album2-track1','track1.mp3',0,1,1,0,6,0,NULL,0);
INSERT INTO Media VALUES(5,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album2-track2','track2.mp3',0,1,1,0,6,0,NULL,0);
INSERT INTO Media VALUES(6,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album2-track3','track3.mp3',0,1,1,0,6,0,NULL,0);
INSERT INTO Media VALUES(7,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album1-track1','track1.mp3',0,1,1,0,7,0,NULL,0);
INSERT INTO Media VALUES(8,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album1-track2','track2.mp3',0,1,1,0,7,0,NULL,0);
INSERT INTO Media VALUES(9,2,3,10057,-1.0,NULL,NULL,NULL,1623053756,0,'ep2-album1-track3','track3.mp3',0,1,1,0,7,0,NULL,0);
