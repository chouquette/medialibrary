...
namespace
{
    const std::vector<const char*> expectedTriggers{
        ...
        "service_decrement_unplayed_media_sub_removal",
        "service_increment_nb_subs",
        "service_update_unplayed_media",
        ...
        "subscription_decrement_unplayed_media_on_media_destroy",
        "subscription_decrement_unplayed_media_on_removal",
        "subscription_increment_cached_size",
        "subscription_increment_unplayed_media_on_insert",
