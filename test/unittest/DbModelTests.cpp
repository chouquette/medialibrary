...
namespace
{
    const std::vector<const char*> expectedTriggers{
        ...
        "media_decrement_nb_subscriptions",
        ...
        "media_increment_nb_subscriptions",
        "media_update_device_presence",
        "media_update_is_public",
        ...
        "service_decrement_media_counters_sub_removal",
        "service_decrement_nb_subs",
        "service_increment_nb_subs",
        "service_update_media_counters",
        "show_decrement_nb_episode",
        "show_increment_nb_episode",
        "show_update_is_present",
        "subscription_decrement_cached_size",
        "subscription_decrement_cached_size_on_removal",
        "subscription_decrement_media_counters_on_media_destroy",
        "subscription_decrement_media_counters_on_removal",
        "subscription_delete_fts",
        "subscription_increment_cached_size",
        "subscription_increment_media_counters_on_insert",
        "subscription_insert_fts",
        "subscription_propagate_task_deletion",
        "subscription_update_fts",
        "subscription_update_unplayed_media",
    ...
    const std::vector<const char*> expectedIndexes{
        ...
        "subscription_rel_media_id_idx",
        "subscription_rel_subscription_id_idx",
        "subscription_service_id_idx",
...
static void Upgrade34to35( DbModel* T )
{
