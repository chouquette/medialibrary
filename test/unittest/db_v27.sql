...
CREATE TABLE MediaGroup(id_group INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT COLLATE NOCASE,nb_video UNSIGNED INTEGER DEFAULT 0,nb_audio UNSIGNED INTEGER DEFAULT 0,nb_unknown UNSIGNED INTEGER DEFAULT 0,nb_media UNSIGNED INTEGER DEFAULT 0,duration INTEGER DEFAULT 0,creation_date INTEGER NOT NULL,last_modification_date INTEGER NOT NULL,user_interacted BOOLEAN,forced_singleton BOOLEAN);
...
CREATE INDEX media_progress_idx ON Media(progress);
...
CREATE TRIGGER media_group_update_nb_media_types AFTER UPDATE OF type, group_id ON Media WHEN (IFNULL(old.group_id, 0) != IFNULL(new.group_id, 0) OR old.type != new.type) AND new.is_present != 0 BEGIN UPDATE MediaGroup SET nb_video = nb_video + (CASE new.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio + (CASE new.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown + (CASE new.type WHEN 0 THEN 1 ELSE 0 END), last_modification_date = strftime('%s') WHERE new.group_id IS NOT NULL AND id_group = new.group_id; UPDATE MediaGroup SET nb_video = nb_video - (CASE old.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio - (CASE old.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown - (CASE old.type WHEN 0 THEN 1 ELSE 0 END), last_modification_date = strftime('%s') WHERE old.group_id IS NOT NULL AND id_group = old.group_id; END;
CREATE TRIGGER media_group_decrement_nb_media_on_deletion AFTER DELETE ON Media WHEN old.group_id IS NOT NULL BEGIN UPDATE MediaGroup SET nb_video = nb_video - (CASE old.type WHEN 1 THEN 1 ELSE 0 END), nb_audio = nb_audio - (CASE old.type WHEN 2 THEN 1 ELSE 0 END), nb_unknown = nb_unknown - (CASE old.type WHEN 0 THEN 1 ELSE 0 END), nb_media = nb_media - 1, last_modification_date = strftime('%s') WHERE id_group = old.group_id; END;
CREATE TRIGGER media_group_delete_empty_group AFTER UPDATE OF nb_media ON MediaGroup WHEN new.nb_media != old.nb_media AND new.nb_media = 0 BEGIN DELETE FROM MediaGroup WHERE id_group = new.id_group; END;
...
CREATE TRIGGER media_group_update_total_nb_media AFTER UPDATE OF group_id ON Media WHEN IFNULL(old.group_id, 0) != IFNULL(new.group_id, 0) BEGIN UPDATE MediaGroup SET nb_media = nb_media - 1 WHERE old.group_id IS NOT NULL AND id_group = old.group_id; UPDATE MediaGroup SET nb_media = nb_media + 1 WHERE new.group_id IS NOT NULL AND id_group = new.group_id; END;
CREATE TRIGGER media_group_update_nb_media_types_presence AFTER UPDATE OF is_present ON Media WHEN old.is_present != new.is_present AND new.group_id IS NOT NULL BEGIN UPDATE MediaGroup SET nb_video = nb_video +  (CASE new.type WHEN 1 THEN 1 ELSE 0 END) * (CASE new.is_present WHEN 0 THEN -1 ELSE 1 END), nb_audio = nb_audio +  (CASE new.type WHEN 2 THEN 1 ELSE 0 END) * (CASE new.is_present WHEN 0 THEN -1 ELSE 1 END), nb_unknown = nb_unknown +  (CASE new.type WHEN 0 THEN 1 ELSE 0 END) * (CASE new.is_present WHEN 0 THEN -1 ELSE 1 END) WHERE id_group = new.group_id; END;
...
INSERT INTO Settings VALUES(27,2,6);
INSERT INTO Device VALUES(1,'720f7152-67b7-41da-89cf-bf22cef92095','file://',0,1,0,0);
INSERT INTO Folder VALUES(1,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/','thumbnail_sharing',NULL,0,1,0,0,0);
INSERT INTO Folder VALUES(2,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_known_album/','known_artist_known_album',1,0,1,0,2,0);
INSERT INTO Folder VALUES(3,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_unknown_album/','known_artist_unknown_album',1,0,1,0,2,0);
INSERT INTO Folder VALUES(4,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_known_album/','unknown_artist_known_album',1,0,1,0,2,0);
INSERT INTO Folder VALUES(5,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_unknown_album/','unknown_artist_unknown_album',1,0,1,0,2,0);
INSERT INTO Thumbnail VALUES(1,'1.jpg',1,0,1,4);
INSERT INTO Thumbnail VALUES(2,'2.jpg',1,0,1,1);
INSERT INTO Thumbnail VALUES(3,'3.jpg',1,0,1,3);
INSERT INTO ThumbnailLinking VALUES(1,0,0,1,4);
INSERT INTO ThumbnailLinking VALUES(1,1,0,1,4);
INSERT INTO ThumbnailLinking VALUES(3,2,0,1,4);
INSERT INTO ThumbnailLinking VALUES(2,0,0,1,4);
INSERT INTO ThumbnailLinking VALUES(4,2,0,2,4);
INSERT INTO ThumbnailLinking VALUES(5,0,0,3,4);
INSERT INTO ThumbnailLinking VALUES(3,1,0,3,4);
INSERT INTO ThumbnailLinking VALUES(6,0,0,3,4);
INSERT INTO Media VALUES(1,2,3,10057,-1.0,NULL,NULL,NULL,1603287844,0,'Track 1','track.mp3',0,1,1,0,2,0,NULL,0);
INSERT INTO Media VALUES(2,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 2','track2.mp3',0,1,1,0,2,0,NULL,0);
INSERT INTO Media VALUES(3,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 1','track.mp3',0,1,1,0,3,0,NULL,0);
INSERT INTO Media VALUES(4,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 2','track2.mp3',0,1,1,0,3,0,NULL,0);
INSERT INTO Media VALUES(5,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 1','track.mp3',0,1,1,0,4,0,NULL,0);
INSERT INTO Media VALUES(6,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 2','track2.mp3',0,1,1,0,4,0,NULL,0);
INSERT INTO Media VALUES(7,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 1','track.mp3',0,1,1,0,5,0,NULL,0);
INSERT INTO Media VALUES(8,2,3,10057,-1.0,NULL,NULL,NULL,1603287845,0,'Track 2','track2.mp3',0,1,1,0,5,0,NULL,0);
INSERT INTO File VALUES(1,1,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_known_album/track.mp3',1,1603198454,139264,2,0,0,0);
INSERT INTO File VALUES(2,2,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_known_album/track2.mp3',1,1603198453,139264,2,0,0,0);
INSERT INTO File VALUES(3,3,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_unknown_album/track.mp3',1,1603198463,139264,3,0,0,0);
INSERT INTO File VALUES(4,4,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_unknown_album/track2.mp3',1,1603198466,139264,3,0,0,0);
INSERT INTO File VALUES(5,5,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_known_album/track.mp3',1,1603198477,139264,4,0,0,0);
INSERT INTO File VALUES(6,6,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_known_album/track2.mp3',1,1603198481,139264,4,0,0,0);
INSERT INTO File VALUES(7,7,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_unknown_album/track.mp3',1,1603197726,139264,5,0,0,0);
INSERT INTO File VALUES(8,8,NULL,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_unknown_album/track2.mp3',1,1603197730,139264,5,0,0,0);
INSERT INTO Album VALUES(1,'album',3,NULL,NULL,2,20114,1,2);
INSERT INTO Album VALUES(2,NULL,4,NULL,NULL,2,20114,1,2);
INSERT INTO Album VALUES(3,'Known album',1,NULL,NULL,2,20114,1,2);
INSERT INTO Album VALUES(4,NULL,1,NULL,NULL,2,20114,1,2);
INSERT INTO AlbumTrack VALUES(1,1,10057,3,NULL,0,1,0);
INSERT INTO AlbumTrack VALUES(2,2,10057,3,NULL,0,1,0);
INSERT INTO AlbumTrack VALUES(3,3,10057,4,NULL,0,2,0);
INSERT INTO AlbumTrack VALUES(4,4,10057,4,NULL,0,2,0);
INSERT INTO AlbumTrack VALUES(5,5,10057,1,NULL,0,3,0);
INSERT INTO AlbumTrack VALUES(6,6,10057,1,NULL,0,3,0);
INSERT INTO AlbumTrack VALUES(7,7,10057,1,NULL,0,4,0);
INSERT INTO AlbumTrack VALUES(8,8,10057,1,NULL,0,4,0);
...
INSERT INTO Artist VALUES(1,NULL,NULL,2,4,NULL,4);
INSERT INTO Artist VALUES(2,NULL,NULL,0,0,NULL,0);
INSERT INTO Artist VALUES(3,'artist 1',NULL,1,2,NULL,2);
INSERT INTO Artist VALUES(4,'artist 2',NULL,1,2,NULL,2);
INSERT INTO MediaArtistRelation VALUES(1,3);
INSERT INTO MediaArtistRelation VALUES(2,3);
INSERT INTO MediaArtistRelation VALUES(3,4);
INSERT INTO MediaArtistRelation VALUES(4,4);
INSERT INTO MediaArtistRelation VALUES(5,1);
INSERT INTO MediaArtistRelation VALUES(6,1);
INSERT INTO MediaArtistRelation VALUES(7,1);
INSERT INTO MediaArtistRelation VALUES(8,1);
INSERT INTO Task VALUES(1,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_known_album/track.mp3',1,1,2,0,0,0,'');
INSERT INTO Task VALUES(2,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_known_album/track2.mp3',1,2,2,0,0,0,'');
INSERT INTO Task VALUES(3,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_unknown_album/track.mp3',1,3,3,0,0,0,'');
INSERT INTO Task VALUES(4,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/known_artist_unknown_album/track2.mp3',1,4,3,0,0,0,'');
INSERT INTO Task VALUES(5,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_known_album/track.mp3',1,5,4,0,0,0,'');
INSERT INTO Task VALUES(6,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_known_album/track2.mp3',1,6,4,0,0,0,'');
INSERT INTO Task VALUES(7,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_unknown_album/track.mp3',1,7,5,0,0,0,'');
INSERT INTO Task VALUES(8,3,2,0,'file:///home/chouquette/dev/medialibrary/test/samples/samples/music/thumbnail_sharing/unknown_artist_unknown_album/track2.mp3',1,8,5,0,0,0,'');
COMMIT;
